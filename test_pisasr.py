...
def pisa_sr(args):
    ...
    for image_name in image_names:
        ...
        # Translate the image - pass image_name for quality prompt loading
        with torch.no_grad():
            c_t = F.to_tensor(input_image).unsqueeze(0).cuda() * 2 - 1
            inference_time, output_image = model(args.default, c_t, prompt=validation_prompt, image_name=image_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--quality_prompt_path", type=str, default="", help="path to quality prompt directory") 
